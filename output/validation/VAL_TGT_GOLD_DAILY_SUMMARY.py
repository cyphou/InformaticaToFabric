...
# =============================================================================
# Validation Notebook: VAL_TGT_GOLD_DAILY_SUMMARY
# Source: src_ods_orders, src_ods_order_lines, src_pg_products → Target: main.gold.tgt_gold_daily_summary
...
target_table = "main.gold.tgt_gold_daily_summary"
...
source_table = "SCHEMA.src_ods_orders"

key_columns = ['tgt_gold_daily_summary_id']
...
try:
    ...
    distinct_keys = df_target.select("tgt_gold_daily_summary_id").distinct().count()
    key_status = "PASS" if total == distinct_keys else "FAIL"
    dq_checks.append({
        "rule": "Key Uniqueness: tgt_gold_daily_summary_id",
        "result": key_status,
