...
# =============================================================================
# Validation Notebook: VAL_TGT_ALERT_QUEUE
# Source: src_sap_materials, src_sap_warehouse_bins, src_iot_sensors → Target: main.silver.tgt_alert_queue
...
target_table = "main.silver.tgt_alert_queue"
...
source_table = "SCHEMA.src_sap_materials"

key_columns = ['tgt_alert_queue_id']
...
try:
    ...
    distinct_keys = df_target.select("tgt_alert_queue_id").distinct().count()
    key_status = "PASS" if total == distinct_keys else "FAIL"
    dq_checks.append({
        "rule": "Key Uniqueness: tgt_alert_queue_id",
        "result": key_status,
