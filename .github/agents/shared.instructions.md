---
description: "Shared rules for all agents in the Informatica to Databricks + Fabric migration project. USE FOR: enforcing project-wide constraints, coding standards, and safety rules."
---

# Shared Project Rules — Informatica to Databricks + Fabric Migration
...
- **Source**: `src/`
- **Target**: `informatica_to_fabric.egg-info/`, `output/`
- **Tests**: `tests/`
- **Docs**: `docs/`
