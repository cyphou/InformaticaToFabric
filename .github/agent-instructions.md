# Agent Behavior Instructions — Informatica to Databricks + Fabric Migration
...
- **Pipeline**: Informatica → Databricks + Fabric
- **Source**: `src/`
- **Target**: `informatica_to_fabric.egg-info/`, `output/`
- **Tests**: `pytest tests/ --tb=short -q` — 37 test files
