# Multi-Agent Architecture — Informatica to Databricks + Fabric Migration
...
| **@extractor** | Parsing Informatica source artifacts | `src/` extraction modules |
...
| **@generator** | Cross-cutting generation coordination | `informatica_to_fabric.egg-info/`, `output/` generators |
...
| **Formula Correctness** | Valid syntax, correct conversion from Informatica formulas |
